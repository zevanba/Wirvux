    ...
    if (mysqli_num_rows($resCheck) > 0) {
        ...
        if (mysqli_query($conexion, $query)) {
            ...
            try {
			    ...
			    <p>Recuerde si se registro como autonomo crearse una cuenta en stripe y crear una cuenta conectada como autonomo para recibir los retiros</p>
                            <p>Nuestra pasarela de pagos (stripe) se llevara tanto al hacer sus pagos como cliente de un 1,5% + 0,25 y posteriormente nosotros nos llevaremos un 18,5%.</p>
